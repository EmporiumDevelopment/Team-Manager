...
client.on(Events.InteractionCreate, (interaction) => commandHandler.handleInteraction(interaction));
...
client.on(Events.MessageDelete, async (message) => {
    ...
    const [channelIdResult] = await db.execute(`
    ...
    const [messageIdResult] = await db.execute(`
